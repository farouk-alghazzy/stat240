...
> The ^ symbol sets 2 to the power of the sequence of numbers from 0 to 5 counting by 1
...
> The set of numbers x has a total of 10 values which is an even number of values therefore there is not a set median value, so it takes the 5th and 6th values and gets the average between the two values. 
